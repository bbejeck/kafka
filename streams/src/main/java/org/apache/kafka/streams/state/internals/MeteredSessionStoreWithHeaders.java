...
public class MeteredSessionStoreWithHeaders<K, AGG>
    ...
    public KeyValueIterator<Windowed<K>, AggregationWithHeaders<AGG>> fetch(final K key) {
        Objects.requireNonNull(key, "key cannot be null");
        return new MeteredWindowedKeyValueIteratorWithHeaders<>(
    ...
    private <R> QueryResult<R> runRangeQuery(final Query<R> query,
        ...
        if (typedQuery.getKey().isPresent()) {
            ...
            if (rawResult.isSuccess()) {
                final MeteredWindowedKeyValueIteratorWithHeaders<K, AggregationWithHeaders<AGG>> typedResult =
                    new MeteredWindowedKeyValueIteratorWithHeaders<>(
                        rawResult.getResult(),
                        fetchSensor,
                        iteratorDurationSensor,
                        streamsMetrics,
                ...
                final QueryResult<MeteredWindowedKeyValueIteratorWithHeaders<K, AggregationWithHeaders<AGG>>> typedQueryResult =
