...
/**
 * Metered iterator for windowed stores with headers support.
 * Generic over both key and value types to support different header wrapper types
 * (e.g., ValueAndHeaders, AggregationWithHeaders).
 *
 * @param <K> the key type
 * @param <V> the value type (typically ValueAndHeaders or AggregationWithHeaders)
 */
class MeteredWindowedKeyValueIteratorWithHeaders<K, V> implements KeyValueIterator<Windowed<K>, V>, MeteredIterator {
    ...
    MeteredWindowedKeyValueIteratorWithHeaders(final KeyValueIterator<Windowed<Bytes>, byte[]> iter,
