...
public class AggregationWithHeadersSerializer<AGG> implements WrappingNullableSerializer<AggregationWithHeaders<AGG>, Void, AGG> {
    ...
    private byte[] serialize(final String topic, final AGG plainAggregation, final Headers headers) {
        ...
        // is not null as well.
        // Serializing non-null aggregations to null can be useful when working with Optional-like aggregations
        ...
        // Format: [headersSize(varint)][headersBytes][aggregation]
        try (final ByteArrayOutputStream baos = new ByteArrayOutputStream();
            ...
            out.write(rawAggregation);                      // [aggregation]
    ...
    public void setIfUnset(final SerdeGetter getter) {
        // AggregationWithHeadersSerializer never wraps a null serializer (or configure would throw),
