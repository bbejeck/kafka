 ...
 */
public final class EventSessionWindow extends Window {
     ...
     */
    public EventSessionWindow(final long startMs, final long endMs) throws IllegalArgumentException {
        super(startMs, endMs);
    }
    ...
    public boolean overlap(final Window other) throws IllegalArgumentException {
        ...
        final EventSessionWindow otherWindow = (EventSessionWindow) other;
